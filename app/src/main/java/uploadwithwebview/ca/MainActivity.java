...
public class MainActivity extends AppCompatActivity {
    ...
    private WebView web;
    private String webUrl = "https://image.online-convert.com/convert-to-gif";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        web.setWebChromeClient(new WebChromeClient() {
            public boolean onShowFileChooser(
                ...
                chooserIntent.putExtra(Intent.EXTRA_TITLE, "load image");
            ...
            private File createImageFile() throws IOException {
                File imageStorageDir = new File(Environment.getExternalStoragePublicDirectory(
                                Environment.DIRECTORY_PICTURES), "DirectoryNameHere");

                if (!imageStorageDir.exists()) {
                    imageStorageDir.mkdirs();
                }

                imageStorageDir = new File(imageStorageDir +
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType) {
                ...
                try {
                    ...
                    Intent chooserIntent = Intent.createChooser(i, "load image");
